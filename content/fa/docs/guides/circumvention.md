...
{{< hint warning >}}
**درخواست**  
لطفاً از روش‌های ناامن و راه‌هایی که ثابت شده منجر به «[کثیف شدن»](http://localhost:1313/iran-internet/docs/guides/dirty-ip/#%D9%84%DB%8C%D8%B3%D8%AA-%D9%88-%DA%A9%D8%AB%DB%8C%D9%81%DB%8C-ip) IP می‌شود استفاده نکنید.
